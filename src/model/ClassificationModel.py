...
import pandas as pd
import torch
# from simpletransformers.classification.classification_utils import convert_examples_to_features
...
from model.BetoForSequenceClassification import BetoForSequenceClassification
...
class ClassificationModel():
    def __init__(
        ...
        MODEL_CLASSES = {
            ...
            "beto": (BetoConfig, BetoForSequenceClassification, AutoTokenizer)
